...
namespace Substance
{
	...
	namespace Helpers
	{
		...
		SUBSTANCECORE_API int32 UpdateInput(SubstanceAir::GraphInstance* Instance, const uint32& Uid, class UObject* InValue);
		SUBSTANCECORE_API int32 UpdateInput(SubstanceAir::GraphInstance* Instance, const uint32& Uid, const TArray<int32>& InValue);
		SUBSTANCECORE_API int32 UpdateInput(SubstanceAir::GraphInstance* Instance, const uint32& Uid, const TArray<float>& InValue);
		...
		SUBSTANCECORE_API FString GetValueString(const SubstanceAir::InputInstanceBase& Input);
